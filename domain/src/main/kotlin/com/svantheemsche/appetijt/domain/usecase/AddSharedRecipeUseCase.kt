...
class AddSharedRecipeUseCase(
    private val repository: MealPlanRepository
) {
    suspend operator fun invoke(text: String, title: String? = null, date: LocalDate): WorkResult<Unit> {
        return repository.addRecipeFromSharedText(text, title, date)
    }
}
